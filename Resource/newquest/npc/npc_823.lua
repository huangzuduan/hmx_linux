local sq = the_script();
sq:add(ScriptQuest.NPC_VISIT, 823);
...
--杀怪任务1级环时
	if type == 2 then
		...
		if qss < 4 then 
			...
			menu = string.gsub(menu_823_2, "#name#", kill_npc_list70[r][1]);
		...
		if qss >= 4 then 
			...
			menu = string.gsub(menu_823_2, "#name#", kill_npc_list702[r][1]);
...
--杀怪收集物品任务
	if type == 4 then
		if qss < 4 then 
			...
			menu = string.gsub(menu_823_13, "#name#", kill_get_list70[r][1]);	
		...
		if qss >= 4 then 
			...
			menu = string.gsub(menu_823_13, "#name#", kill_get_list702[r][1]);	
...
--收集装备任务
	if type == 5 then
		if qss < 4 then 
			...
			menu = string.gsub(menu_823_15, "#name#", get_weapon_list70[r][1]);	
		...
		if qss >= 4 then 
			...
			menu = string.gsub(menu_823_15, "#name#", get_weapon_list702[r][1]);	
...
--杀BOSS任务	
	...
	--print("杀BOSS判断通过");
		if qss < 4 then 
			...
			menu = string.gsub(menu_823_17, "#name#", kill_boss_list[r][1]);	
		...
		if qss >= 4 then 
			...
			menu = string.gsub(menu_823_17, "#name#", kill_boss_list2[r][1]);	
...
--任务等级判断
	...
	if level ~= 1 and level ~= 70 and level ~= 0 then 
		return 0;
	end			
...
--等级判断
	...
	local s = v:get("state");
	if (player.charbase.level < 100 or player.charbase.level >= 110) and s ~= 1 and s ~= -3 then
			return 0;
	end
...
--访问任务1级环提示
	if s == 1 and type == 1 then
			...
			if qss < 4 then 
				menu = string.gsub(menu_823_5, "#place#", visit_npc_list70[r][1]);	
				menu = 	string.gsub(menu, "#npc#", visit_npc_list70[r][2]);
				show_dialog(npc, menu);
			end
			if qss >= 4 then 
				menu = string.gsub(menu_823_5, "#place#", visit_npc_list702[r][1]);	
				menu = 	string.gsub(menu, "#npc#", visit_npc_list702[r][2]);
			end
			show_dialog(npc, menu);
		return 1;	
...
--杀怪任务提示
	if s == 1 and type == 2 then
			...
			if qss < 4 then 
				menu = string.gsub(menu_823_6, "#name#", kill_npc_list70[r][1]);
				menu = 	string.gsub(menu, "#npc#", kill_npc_list70[r][2]);
			end 
			if qss >= 4 then 
				menu = string.gsub(menu_823_6, "#name#", kill_npc_list702[r][1]);
				menu = 	string.gsub(menu, "#npc#", kill_npc_list702[r][2]);
			end 
			show_dialog(npc, menu);
		return 1;	
...
--物品收集交任务
	if s == 1 and type == 3 then
			...
			if qss < 4 then 
				menu = string.gsub(menu_823_8, "#name#", get_item_list70[r][1]);	
				menu = 	string.gsub(menu, "#id#", get_item_list70[r][2]);
			end 
			if qss >= 4 then 
				menu = string.gsub(menu_823_8, "#name#", get_item_list702[r][1]);	
				menu = 	string.gsub(menu, "#id#", get_item_list702[r][2]);
			end 
			show_dialog(npc, menu);
		return 1;	
...
--物品收集接任务	
	if s == 1 and type == 3 then
			local r=v:get("questobject");
			if qss < 4 then 
				menu = string.gsub(menu_823_4, "#name#", get_item_list70[r][1]);	
				menu = 	string.gsub(menu, "#id#", get_item_list70[r][2]);
			end
			if qss >= 4 then 
				menu = string.gsub(menu_823_4, "#name#", get_item_list702[r][1]);	
				menu = 	string.gsub(menu, "#id#", get_item_list702[r][2]);
			end
			show_dialog(npc, menu);
		return 1;	
...
--杀怪收集物品接任务
	if s == 1 and type == 4 then
			...
			if qss < 4 then 
				menu = string.gsub(menu_823_23, "#name#", kill_get_list70[r][1]);	
				menu = 	string.gsub(menu, "#kill#", kill_get_list70[r][2]);
				menu = 	string.gsub(menu, "#item#", kill_get_list70[r][3]);
			end 
			if qss >= 4 then 
				menu = string.gsub(menu_823_23, "#name#", kill_get_list702[r][1]);	
				menu = 	string.gsub(menu, "#kill#", kill_get_list702[r][2]);
				menu = 	string.gsub(menu, "#item#", kill_get_list702[r][3]);
			end 
			show_dialog(npc, menu);
...
--杀怪收集物品交任务	
	if s == -3 and type == 4 then
			local r=v:get("questkillobject");
			if qss < 4 then
				menu = string.gsub(menu_823_31, "#name#", kill_get_list70[r][1]);	
				menu = 	string.gsub(menu, "#kill#", kill_get_list70[r][2]);
				menu = 	string.gsub(menu, "#item#", kill_get_list70[r][3]);
			end 
			if qss >= 4 then
				menu = string.gsub(menu_823_31, "#name#", kill_get_list702[r][1]);	
				menu = 	string.gsub(menu, "#kill#", kill_get_list702[r][2]);
				menu = 	string.gsub(menu, "#item#", kill_get_list702[r][3]);
			end 
			show_dialog(npc, menu);
...
--收集装备交任务对话
	...
	if s == 1 and type == 5 and (weapon ~= 0 or weapon2 ~= 0) then
		if qss < 4 then	
			...
			menu = string.gsub(menu_823_35, "#name#", get_weapon_list70[r][1]);	
			menu = 	string.gsub(menu, "#id#", get_weapon_list70[r][2]);
			menu = 	string.gsub(menu, "#color#", get_weapon_list70[r][3]);
			show_dialog(npc, menu);
			return 1;
		...
		if qss >= 4 then	
			local r=v:get("weaponrequire");
			menu = string.gsub(menu_823_35, "#name#", get_weapon_list702[r][1]);	
			menu = 	string.gsub(menu, "#id#", get_weapon_list702[r][2]);
			menu = 	string.gsub(menu, "#color#", get_weapon_list702[r][3]);
			show_dialog(npc, menu);
			return 1;
...
--收集装备接任务对话
	if s == 1 and type == 5 then
			local r=v:get("weaponrequire");
			if qss < 4 then
				menu = string.gsub(menu_823_45, "#name#", get_weapon_list70[r][1]);	
				menu = 	string.gsub(menu, "#id#", get_weapon_list70[r][2]);
				menu = 	string.gsub(menu, "#color#", get_weapon_list70[r][3]);
			end
			if qss >= 4 then
				menu = string.gsub(menu_823_45, "#name#", get_weapon_list702[r][1]);	
				menu = 	string.gsub(menu, "#id#", get_weapon_list702[r][2]);
				menu = 	string.gsub(menu, "#color#", get_weapon_list702[r][3]);
			end
			show_dialog(npc, menu);
...
--杀BOSS接任务对话
	...
	--print("判断通过！！");
			...
			if qss < 4 then
				menu = string.gsub(menu_823_7, "#name#", kill_boss_list[r][1]);	
				menu = 	string.gsub(menu, "#id#", kill_boss_list[r][2]);
				show_dialog(npc, menu);
			end
			if qss >= 4 then
				menu = string.gsub(menu_823_7, "#name#", kill_boss_list2[r][1]);	
				menu = 	string.gsub(menu, "#id#", kill_boss_list2[r][2]);
			end
			show_dialog(npc, menu);
		return 1;	
...
function accept_823(npc, id, flag)
		player = me();
...
--print("40~50找人任务");
		...
		if( v:get("state") == 2) and flag == 1 and type == 1 then
			...
			if qss < 4 then 
				...
				menu = 	string.gsub(menu, "#npc#", visit_npc_list70[r][2]);
				show_dialog(npc, menu);
				local xxxx="把信带给#place#然后向环式任务使者(100)汇报";
...
--杀怪任务1级接任务判断
	  if( v:get("state") == 2) and flag == 2 then
			...
			if qss < 4 then 
				menu = string.gsub(menu_823_6, "#name#", kill_npc_list70[r][1]);
				menu = 	string.gsub(menu, "#npc#", kill_npc_list70[r][2]);
				local xxxx="攻击#name#15只然后向环式任务使者(100)汇报";
...
--收集物品1级接任务判断	
		if( v:get("state") == 2) and flag == 3 then
			...
			if qss < 4 then 
				menu = string.gsub(menu_823_4, "#name#", get_item_list70[r][1]);	
				menu = 	string.gsub(menu, "#id#", get_item_list70[r][2]);
				local xxxx="去收集#name#3个给环式任务使者(100)";
...
--杀怪收集物品接任务判断  
		if( v:get("state") == 2) and flag == 13 then
			...
			if qss < 4 then
				...
				menu = 	string.gsub(menu, "#kill#", kill_get_list70[r][2]);
				menu = 	string.gsub(menu, "#item#", kill_get_list70[r][3]);
				local xxxx="#name#，然后向环式任务使者(100)汇报";
...
--收集装备接任务判断  
		if( v:get("state") == 2) and type == 5 and flag == 15 then
		  ...
		  if qss < 4 then 
				...
				menu = 	string.gsub(menu, "#id#", get_weapon_list70[r][2]);
				menu = 	string.gsub(menu, "#color#", get_weapon_list70[r][3]);
				local xxxx="收集一个#name#交给环式任务使者(100)";
...
--杀BOSS任务接任务判断
		if( v:get("state") == 2) and type == 6 and flag == 17 then
			...
			if qss < 4 then 
				...
				menu = string.gsub(menu, "#id#", kill_boss_list[r][2]);
				show_dialog(npc, menu);
				local xxxx="去杀#name#然后向环式任务使者(100)汇报";
