local sq = the_script();
sq:add(ScriptQuest.NPC_VISIT, 822);
...
--访问任务1级环时
	...
	--print("40~50读表");
	  ...
	  if qss < 4 then 
			r = math.random(1, table.getn(visit_npc_list60));
			menu = string.gsub(menu_822_1, "#place#", visit_npc_list60[r][1]);	
			menu = 	string.gsub(menu, "#npc#", visit_npc_list60[r][2]);
			id = visit_npc_list60[r][2];
		end
		if qss >= 4 then 
			r = math.random(1, table.getn(visit_npc_list602));
			menu = string.gsub(menu_822_1, "#place#", visit_npc_list602[r][1]);	
			menu = 	string.gsub(menu, "#npc#", visit_npc_list602[r][2]);	
			id = visit_npc_list602[r][2];
		end
...
--杀怪任务1级环时
	if type == 2 then
		...
		if qss < 4 then 
			r = math.random(1, table.getn(kill_npc_list60));
			menu = string.gsub(menu_822_2, "#name#", kill_npc_list60[r][1]);
			menu = 	string.gsub(menu, "#npc#", kill_npc_list60[r][2]);
			id = kill_npc_list60[r][2]; 
		end
		
		if qss >= 4 then 
			r = math.random(1, table.getn(kill_npc_list602));
			menu = string.gsub(menu_822_2, "#name#", kill_npc_list602[r][1]);
			menu = 	string.gsub(menu, "#npc#", kill_npc_list602[r][2]);
			id = kill_npc_list602[r][2]; 
		end
...
--收集物品任务	
	if type == 3 then
		if qss < 4 then 
			r = math.random(1, table.getn(get_item_list60));
			menu = string.gsub(menu_822_3, "#name#", get_item_list60[r][1]);	
			menu = 	string.gsub(menu, "#id#", get_item_list60[r][2]);
			id = get_item_list60[r][2];
		end
		if qss >= 4 then 
			r = math.random(1, table.getn(get_item_list602));
			menu = string.gsub(menu_822_3, "#name#", get_item_list602[r][1]);	
			menu = 	string.gsub(menu, "#id#", get_item_list602[r][2]);
			id = get_item_list602[r][2];
		end
...
--杀怪收集物品任务
	if type == 4 then
		if qss < 4 then 
			r = math.random(1, table.getn(kill_get_list60));
			menu = string.gsub(menu_822_13, "#name#", kill_get_list60[r][1]);	
			menu = 	string.gsub(menu, "#kill#", kill_get_list60[r][2]);
			menu = 	string.gsub(menu, "#item#", kill_get_list60[r][3]);	
			id = kill_get_list60[r][2];
			item = kill_get_list60[r][3];
		end
		if qss >= 4 then 
			r = math.random(1, table.getn(kill_get_list602));
			menu = string.gsub(menu_822_13, "#name#", kill_get_list602[r][1]);	
			menu = 	string.gsub(menu, "#kill#", kill_get_list602[r][2]);
			menu = 	string.gsub(menu, "#item#", kill_get_list602[r][3]);	
			id = kill_get_list602[r][2];
			item = kill_get_list602[r][3];
		end
...
--收集装备任务
	if type == 5 then
		if qss < 4 then 
			r = math.random(1, table.getn(get_weapon_list60));
			menu = string.gsub(menu_822_15, "#name#", get_weapon_list60[r][1]);	
			menu = string.gsub(menu, "#id#", get_weapon_list60[r][2]);
			menu = string.gsub(menu, "#color#", get_weapon_list60[r][3]);
			id = get_weapon_list60[r][2];
			color = get_weapon_list60[r][3];
		end
		if qss >= 4 then 
			r = math.random(1, table.getn(get_weapon_list602));
			menu = string.gsub(menu_822_15, "#name#", get_weapon_list602[r][1]);	
			menu = string.gsub(menu, "#id#", get_weapon_list602[r][2]);
			menu = string.gsub(menu, "#color#", get_weapon_list602[r][3]);
			id = get_weapon_list602[r][2];
			color = get_weapon_list602[r][3];
		end
...
--杀BOSS任务	
	...
	--print("杀BOSS判断通过");
		if qss < 4 then 
			...
			menu = string.gsub(menu_822_17, "#name#", kill_boss_list[r][1]);	
		...
		if qss >= 4 then 
			...
			menu = string.gsub(menu_822_17, "#name#", kill_boss_list2[r][1]);	
...
--任务等级判断
	...
	if level ~= 1 and level ~= 60 and level ~= 0 then 
		return 0;
	end			
...
--等级判断
	...
	local s = v:get("state");
	if (player.charbase.level < 90 or player.charbase.level >= 100) and s ~= 1 and s ~= -3 then
			return 0;
	end
...
--环数到上限，设置个人变量	
	...
	if not v then
		v = Vars(21102);
		local type, id = select_quest60(npc,v);
...
--访问任务1级环提示
	if s == 1 and type == 1 then
			...
			if qss < 4 then 
				menu = string.gsub(menu_822_5, "#place#", visit_npc_list60[r][1]);	
				menu = 	string.gsub(menu, "#npc#", visit_npc_list60[r][2]);
				show_dialog(npc, menu);
			end
			if qss >= 4 then 
				menu = string.gsub(menu_822_5, "#place#", visit_npc_list602[r][1]);	
				menu = 	string.gsub(menu, "#npc#", visit_npc_list602[r][2]);
			end
			show_dialog(npc, menu);
		return 1;	
...
--杀怪任务提示
	if s == 1 and type == 2 then
			...
			if qss < 4 then 
				menu = string.gsub(menu_822_6, "#name#", kill_npc_list60[r][1]);
				menu = 	string.gsub(menu, "#npc#", kill_npc_list60[r][2]);
			end 
			if qss >= 4 then 
				menu = string.gsub(menu_822_6, "#name#", kill_npc_list602[r][1]);
				menu = 	string.gsub(menu, "#npc#", kill_npc_list602[r][2]);
			end 
			show_dialog(npc, menu);
		return 1;	
...
--物品收集交任务
	if s == 1 and type == 3 then
			...
			if qss < 4 then 
				menu = string.gsub(menu_822_8, "#name#", get_item_list60[r][1]);	
				menu = 	string.gsub(menu, "#id#", get_item_list60[r][2]);
			end 
			if qss >= 4 then 
				menu = string.gsub(menu_822_8, "#name#", get_item_list602[r][1]);	
				menu = 	string.gsub(menu, "#id#", get_item_list602[r][2]);
			end 
			show_dialog(npc, menu);
		return 1;	
...
--物品收集接任务	
	if s == 1 and type == 3 then
			local r=v:get("questobject");
			if qss < 4 then 
				menu = string.gsub(menu_822_4, "#name#", get_item_list60[r][1]);	
				menu = 	string.gsub(menu, "#id#", get_item_list60[r][2]);
			end
			if qss >= 4 then 
				menu = string.gsub(menu_822_4, "#name#", get_item_list602[r][1]);	
				menu = 	string.gsub(menu, "#id#", get_item_list602[r][2]);
			end
			show_dialog(npc, menu);
		return 1;	
...
--杀怪收集物品接任务
	if s == 1 and type == 4 then
			...
			if qss < 4 then 
				menu = string.gsub(menu_822_23, "#name#", kill_get_list60[r][1]);	
				menu = 	string.gsub(menu, "#kill#", kill_get_list60[r][2]);
				menu = 	string.gsub(menu, "#item#", kill_get_list60[r][3]);
			end 
			if qss >= 4 then 
				menu = string.gsub(menu_822_23, "#name#", kill_get_list602[r][1]);	
				menu = 	string.gsub(menu, "#kill#", kill_get_list602[r][2]);
				menu = 	string.gsub(menu, "#item#", kill_get_list602[r][3]);
			end 
			show_dialog(npc, menu);
...
--杀怪收集物品交任务	
	if s == -3 and type == 4 then
			local r=v:get("questkillobject");
			if qss < 4 then
				menu = string.gsub(menu_822_31, "#name#", kill_get_list60[r][1]);	
				menu = 	string.gsub(menu, "#kill#", kill_get_list60[r][2]);
				menu = 	string.gsub(menu, "#item#", kill_get_list60[r][3]);
			end 
			if qss >= 4 then
				menu = string.gsub(menu_822_31, "#name#", kill_get_list602[r][1]);	
				menu = 	string.gsub(menu, "#kill#", kill_get_list602[r][2]);
				menu = 	string.gsub(menu, "#item#", kill_get_list602[r][3]);
			end 
			show_dialog(npc, menu);
...
--收集装备交任务对话
	...
	if s == 1 and type == 5 and (weapon ~= 0 or weapon2 ~= 0) then
		if qss < 4 then	
			...
			menu = string.gsub(menu_822_35, "#name#", get_weapon_list60[r][1]);	
			menu = 	string.gsub(menu, "#id#", get_weapon_list60[r][2]);
			menu = 	string.gsub(menu, "#color#", get_weapon_list60[r][3]);
			show_dialog(npc, menu);
			return 1;
		...
		if qss >= 4 then	
			local r=v:get("weaponrequire");
			menu = string.gsub(menu_822_35, "#name#", get_weapon_list602[r][1]);	
			menu = 	string.gsub(menu, "#id#", get_weapon_list602[r][2]);
			menu = 	string.gsub(menu, "#color#", get_weapon_list602[r][3]);
			show_dialog(npc, menu);
			return 1;
...
--收集装备接任务对话
	if s == 1 and type == 5 then
			local r=v:get("weaponrequire");
			if qss < 4 then
				menu = string.gsub(menu_822_45, "#name#", get_weapon_list60[r][1]);	
				menu = 	string.gsub(menu, "#id#", get_weapon_list60[r][2]);
				menu = 	string.gsub(menu, "#color#", get_weapon_list60[r][3]);
			end
			if qss >= 4 then
				menu = string.gsub(menu_822_45, "#name#", get_weapon_list602[r][1]);	
				menu = 	string.gsub(menu, "#id#", get_weapon_list602[r][2]);
				menu = 	string.gsub(menu, "#color#", get_weapon_list602[r][3]);
			end
			show_dialog(npc, menu);
...
--杀BOSS接任务对话
	...
	--print("判断通过！！");
			...
			if qss < 4 then
				menu = string.gsub(menu_822_7, "#name#", kill_boss_list[r][1]);	
				menu = 	string.gsub(menu, "#id#", kill_boss_list[r][2]);
				show_dialog(npc, menu);
			end
			if qss >= 4 then
				menu = string.gsub(menu_822_7, "#name#", kill_boss_list2[r][1]);	
				menu = 	string.gsub(menu, "#id#", kill_boss_list2[r][2]);
			end
			show_dialog(npc, menu);
		return 1;	
...
function accept_822(npc, id, flag)
		player = me();
...
--print("40~50找人任务");
		...
		if( v:get("state") == 2) and flag == 1 and type == 1 then
			...
			if qss < 4 then 
				...
				menu = 	string.gsub(menu, "#npc#", visit_npc_list60[r][2]);
				show_dialog(npc, menu);
				local xxxx="把信带给#place#然后向环式任务使者(90)汇报";
				xxxx = string.gsub(xxxx, "#place#", visit_npc_list60[r][1]);	
				v:sets("text", xxxx);
				v:refresh(player,"text")
			end
			...
			if qss >= 4 then 
				...
				show_dialog(npc, menu);
				local xxxx="把信带给#place#然后向环式任务使者(90)汇报";
				xxxx = string.gsub(xxxx, "#place#", visit_npc_list602[r][1]);	
				v:sets("text", xxxx);
				v:refresh(player,"text")
			end
...
--杀怪任务1级接任务判断
	  if( v:get("state") == 2) and flag == 2 then
			...
			if qss < 4 then 
				menu = string.gsub(menu_822_6, "#name#", kill_npc_list60[r][1]);
				menu = 	string.gsub(menu, "#npc#", kill_npc_list60[r][2]);
				local xxxx="攻击#name#15只然后向环式任务使者(90)汇报";
				xxxx = string.gsub(xxxx, "#name#", kill_npc_list60[r][1]);
				v:sets("text", xxxx);
				v:refresh(player,"text")
			end
			if qss >= 4 then 
				...
				menu = 	string.gsub(menu, "#npc#", kill_npc_list602[r][2]);
				local xxxx="攻击#name#15只然后向环式任务使者(90)汇报";
				xxxx = string.gsub(xxxx, "#name#", kill_npc_list602[r][1]);
				v:sets("text", xxxx);
				v:refresh(player,"text")
			end
...
--收集物品1级接任务判断	
		if( v:get("state") == 2) and flag == 3 then
			...
			if qss < 4 then 
				menu = string.gsub(menu_822_4, "#name#", get_item_list60[r][1]);	
				menu = 	string.gsub(menu, "#id#", get_item_list60[r][2]);
				local xxxx="去收集#name#3个给环式任务使者(90)";
				xxxx = string.gsub(xxxx, "#name#", get_item_list60[r][1]);	
				v:sets("text", xxxx);
				v:refresh(player,"text")
			end
			if qss >= 4 then 
				...
				menu = 	string.gsub(menu, "#id#", get_item_list602[r][2]);
				local xxxx="去收集#name#3个给环式任务使者(90)";
				xxxx = string.gsub(xxxx, "#name#", get_item_list602[r][1]);	
				v:sets("text", xxxx);
				v:refresh(player,"text")
			end
...
--杀怪收集物品接任务判断  
		if( v:get("state") == 2) and flag == 13 then
			...
			if qss < 4 then
				...
				menu = 	string.gsub(menu, "#kill#", kill_get_list60[r][2]);
				menu = 	string.gsub(menu, "#item#", kill_get_list60[r][3]);
				local xxxx="#name#，然后向环式任务使者(90)汇报";
				xxxx = string.gsub(xxxx, "#name#", kill_get_list60[r][1]);	
				v:sets("text", xxxx);
				v:refresh(player,"text")
			end
			if qss >= 4 then
				...
				menu = 	string.gsub(menu, "#item#", kill_get_list602[r][3]);
				local xxxx="#name#，然后向环式任务使者(90)汇报";
				xxxx = string.gsub(xxxx, "#name#", kill_get_list602[r][1]);	
				v:sets("text", xxxx);
				v:refresh(player,"text")
			end
...
--收集装备接任务判断  
		if( v:get("state") == 2) and type == 5 and flag == 15 then
		  ...
		  if qss < 4 then 
				...
				menu = 	string.gsub(menu, "#id#", get_weapon_list60[r][2]);
				menu = 	string.gsub(menu, "#color#", get_weapon_list60[r][3]);
				local xxxx="收集一个#name#交给环式任务使者(90)";
				xxxx = string.gsub(xxxx, "#name#", get_weapon_list60[r][1]);	
				v:sets("text", xxxx);
				v:refresh(player,"text")
				v:set("starttime", time());
			end
			...
			if qss >= 4 then 
				...
				show_dialog(npc, menu);
				local xxxx="收集一个#name#交给环式任务使者(90)";
				xxxx = string.gsub(xxxx, "#name#", get_weapon_list602[r][1]);	
				v:sets("text", xxxx);
				v:refresh(player,"text")
			end
...
--杀BOSS任务接任务判断
		if( v:get("state") == 2) and type == 6 and flag == 17 then
			...
			if qss < 4 then 
				...
				menu = string.gsub(menu, "#id#", kill_boss_list[r][2]);
				show_dialog(npc, menu);
				local xxxx="去杀#name#然后向环式任务使者(90)汇报";
