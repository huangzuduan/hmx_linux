...
bool zSerivceCfgMgr::loadConfig(const char* filename)
{
	...
	while (serverNode)
	{
		...
		xml.getNodePropStr(serverNode, "name",serverInfo.name,sizeof(serverInfo.name));
		...
		while (serivceNode)
		{
			...
			xml.getNodePropStr(serivceNode, "name", serivceInfo.name,sizeof(serivceInfo.name));
			xml.getNodePropNum(serivceNode, "remoteid", &serivceInfo.remoteid, sizeof(serivceInfo.remoteid));
			xml.getNodePropStr(serivceNode, "ip", serivceInfo.ip, sizeof(serivceInfo.ip));
			...
			xml.getNodePropStr(serivceNode, "fun", serivceInfo.fun, sizeof(serivceInfo.fun));
			xml.getNodePropStr(serivceNode, "user", serivceInfo.user, sizeof(serivceInfo.user));
			xml.getNodePropStr(serivceNode, "passwd", serivceInfo.passwd, sizeof(serivceInfo.passwd));
			xml.getNodePropStr(serivceNode, "value", serivceInfo.value, sizeof(serivceInfo.value));
