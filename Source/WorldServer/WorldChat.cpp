...
{
	return zEntryMgr< zEntryID, zEntryTempID, zEntryName >::addEntry(channel);
}
...
{
	zEntryMgr< zEntryID, zEntryTempID, zEntryName >::removeEntry(channel);
}
...
{
	return (WorldChannel *)zEntryMgr< zEntryID, zEntryTempID, zEntryName >::getEntryByID(dwChannelID);
}
