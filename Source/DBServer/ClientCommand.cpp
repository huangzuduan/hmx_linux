...
{
	//commands.push_back( KeyCommand("0"," 断开连接 "		,	ClientNetHandler::SendRequestClose));
	//commands.push_back( KeyCommand("11"," 登录hzd账号 "		,	ClientNetHandler::SendLogin));
	//commands.push_back( KeyCommand("22"," 登录kfc账号 "		,	ClientNetHandler::SendLogin2));
}
